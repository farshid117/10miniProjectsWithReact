    ...
    return (
        <>
           <div className="container">
                <Grid container spacing={5} className='mt-5 align-items-center'>
                    <Grid xs={12} md={6} className="text-center" >
                        <Typography variant='h4'color="#ccc" sx={{ fontWeight: "bold", mb: 5, textShadow: "2px 2px 15px #fff" }}>{course.title}</Typography>
                        <Typography variant='subtitle1' color="#fff" className='justify fw-bold' >{course.description}</Typography>
